...
import com.vidhaitechnologies.arattai.dashboard.AddGroupActivity;
import com.vidhaitechnologies.arattai.dashboard.adapter.ListGroupsAdapter;
...
public class GroupFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private LovelyProgressDialog progressDialog, waitingLeavingGroup;
